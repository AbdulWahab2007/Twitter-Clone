...
export default function UserProfile() {
  ...
  const handleloadtweets = async () => {
    const response = axios
      .get("http://localhost:5000/api/tweet?username=" + username)
      .then(function (response) {
      ...
      <Container>
        ...
        <Info>
          {userData.additionalData ? (
            <img
              src={userData.additionalData.coverPhoto}
          ...
          <div className="DPholder">
            {userData.additionalData ? (
              <img
                src={userData.additionalData.profilePic}
                className="DP"
                alt="Image"
              />
            ) : (
              ...
              <>
                ...
                <div className="personalInfo">
                  ...
                  <p className="row">
                    ...
                    {userData.additionalData.additionalData.dob.substring(
                      0,
                      15
                    )}
                  </p>
